                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="first-name" required="required"
                                               class="form-control col-md-7 col-xs-12" name="username" value="{{$user->username}}" >
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="role">
                                            ...
                                            <option value="1" @php if ($user->role == 1) echo "selected"; @endphp>مدیر کل</option>
                                            <option value="2" @php if ($user->role == 2) echo "selected"; @endphp >مدیر ارشد</option>
                                            <option value="3" @php if ($user->role == 3) echo "selected"; @endphp>کاربر</option>
                                        </select>
                                    </div>
                                </div>
